...
<div class="pewc-fields-wrapper">
    ...
    <div class="product-extra-field pewc-default-fields pewc-misc-fields">
        ...
        <div class="product-extra-field-inner">
            ...
            <input type="number" class="pewc-field-item pewc-field-default pewc-field-default-field-number" name="<?php echo esc_attr( $base_name ); ?>[field_default]" step="<?php echo apply_filters( 'pewc_number_field_step', '1', $item ); ?>" value="<?php echo esc_attr( $default ); ?>" data-field-name="field_default">
