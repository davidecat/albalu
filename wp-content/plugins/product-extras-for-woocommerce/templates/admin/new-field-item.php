				...
				<div class="pewc-fields-wrapper pewc-products-extras">
					<div class="product-extra-field-full">
						...
						<div class="product-extra-field-two-thirds-right">
							<?php
							// 3.27.3
							$child_product_method = ( 'yes' === get_option( 'pewc_child_variations', 'yes' ) ) ? 'woocommerce_json_search_products_and_variations' : 'woocommerce_json_search_products';
							?>
							<select class="wc-product-search pewc-field-child_products pewc-data-options" multiple="multiple" style="width: 100%;" name="" data-action="<?php echo $child_product_method; ?>" data-include="" data-exclude="">
							</select>
						</div>
