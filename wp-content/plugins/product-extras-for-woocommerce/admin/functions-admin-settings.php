...
function pewc_get_products_settings() {
	...
	$settings = array(
		...
		'pewc_enable_plus_minus_buttons' => array(
			'name'		=> __( 'Enable plus minus buttons', 'pewc' ),
			'type'		=> 'checkbox',
			'desc_tip'	=> true,
			'desc'		=> __( 'Enable this to show + and - buttons alongside quantity fields in Products fields.', 'pewc' ),
			'id'			=> 'pewc_enable_plus_minus_buttons',
			'default'	=> 'no',
			'std'			=> 'no'
		),
