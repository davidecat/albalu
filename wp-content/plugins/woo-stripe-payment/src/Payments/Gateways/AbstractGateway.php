...
abstract class AbstractGateway extends \WC_Payment_Gateway {
	...
	public function get_tokens() {
		$tokens = parent::get_tokens(); // TODO: Change the autogenerated stub

		return \PaymentPlugins\Stripe\Utilities\PaymentMethodUtils::sort_by_default(
			\PaymentPlugins\Stripe\Utilities\PaymentMethodUtils::filter_by_type(
				$tokens
			)
		);
	}
	...
	public function saved_payment_methods() {
		...
		echo apply_filters( 'wc_payment_gateway_form_saved_payment_methods_html', $html, $this ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
	...
	public function get_saved_payment_method_option_html( $token, $checked = true ) {
		...
		$html = sprintf(
			...
			esc_url( $icon_url ),
			esc_attr( $token->get_brand() ),
			esc_attr( $classes ),
			esc_attr( $style ),
			\count( $this->get_tokens() ) > 1 ? sprintf(
				'<a class="wc-stripe-saved-method__see-more" href="#">%1$s</a>',
				esc_html__( 'See more', 'woo-stripe-payment' )
			) : ''
		);
