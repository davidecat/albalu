...
===========
  ...
  For more information about GNU/LGPL license : http:
...
7 - Documentation
=================
  PclZip User Manuel is available in English on PhpConcept : http:
  A Russian translation was done by Feskov Kuzma : http:
