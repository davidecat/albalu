...
= 3.12.4 =
* Fixed: Prevented multiple unnecessary scans by enforcing a 3-week interval for configuration reload

= 3.12.3 =
* Fix Footer issue in new themes
...
= 3.11.3 =
* Fixed: Update URLs for Autoblocking and Sync scripts.
